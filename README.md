...
- Nume : String [Required]
    ── Numele playlist-ului (ex: "Muzică favorita", "Tutoriale", "Gameplay-uri")

- Descriere : Text
    ── O descriere detaliată a playlist-ului

- Data creării : DateTime
    ── Data și ora când a fost creat playlist-ul (se generează automat)

- Categorie : String
    ── Categoria din care face parte (ex: "Muzică", "Educație", "Gaming", "Documentar", etc.)

- Vizibilitate : Boolean
    ── true / false (Playlist public / privat)

### Video (entitate copil)
- ID : Number (Primary Key)
    ── Identificator unic generat automat pentru fiecare video

- ID Playlist : Number (Foreign Key)
    ── Referință către playlist-ul părinte

- Titlu : String
    ── Titlul videoclipului preluat din YouTube

- URL YouTube : String 
    ── Link-ul complet către videoclipul de pe YouTube
    ── Format: https://www.youtube.com/watch?v=XXXXXX

- Thumbnail : String
    ── URL către imaginea de previzualizare a videoclipului

- Data adăugării : DateTime
    ── Data și ora când a fost adăugat videoclipul (se generează automat)

- Durata : String
    ── Durata videoclipului (ex: "13:37", "1:02:45")

- Status : Boolean
    ── true / false (Video vizionat / nevizionat)
